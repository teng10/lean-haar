...
theorem IsIrreducible.intertwiningMap_eq_smul_id (ρ : Representation ℂ G V)
...
theorem IsIrreducible.intertwiningMap_eq_trace_div_finrank_smul_id
  ...
  obtain ⟨c, hc⟩ := IsIrreducible.intertwiningMap_eq_smul_id ρ f
...
theorem IsIrreducible.intertwiningMap_eq_zero_of_isEmpty_equiv
...
theorem IsIrreducible.average_eq_trace_div_finrank_smul_id
    (ρ : Representation ℂ G V) [ρ.IsIrreducible] [FiniteDimensional ℂ V]
  ...
  rw [IsIrreducible.intertwiningMap_eq_trace_div_finrank_smul_id ρ average, htrace]
...
theorem IsIrreducible.isotypicBlockAverage_eq_depolarizing
    (ρ : Representation ℂ G V) [ρ.IsIrreducible] [FiniteDimensional ℂ V]
  ...
  intro i j
  exact IsIrreducible.average_eq_trace_div_finrank_smul_id ρ (A i j) (average i j)
    (htrace i j)
