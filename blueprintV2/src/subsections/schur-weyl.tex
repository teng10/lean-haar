...
\begin{definition}[Endomorphism Matrix Representation (Primed)]\label{def:toEndMatrix'}
  \lean{SchurWeyl.toEndMatrix'}\uses{def:tensorBasis'}\leanok
...
\begin{definition}[Permutation Monoid Homomorphism]\label{def:permMonoidHom}
  \lean{SchurWeyl.permMonoidHom}\uses{lem:permAction_tprod, def:permAction}\leanok
...
\begin{definition}[Permutation Representation]\label{def:permRep}
  \lean{SchurWeyl.permRep}\uses{def:permMonoidHom}\leanok
...
\begin{definition}[Centralizer to EndModule Mapping]\label{def:centralizer_to_endModule}
  \lean{SchurWeyl.centralizer_to_endModule}\uses{def:PermModule, def:permRep, def:permImage, thm:permAlgHom_range_eq}\leanok
...
\begin{definition}[Double Centralizer to EndEndModule Mapping]\label{def:doubleCentralizer_to_endEndModule}
  \lean{SchurWeyl.doubleCentralizer_to_endEndModule}\uses{def:PermModule, def:permImage, lem:endModule_mem_centralizer}\leanok
...
\begin{lemma}[EndModule is in Centralizer]\label{lem:endModule_mem_centralizer}
  \lean{SchurWeyl.endModule_mem_centralizer}\uses{def:PermModule, def:permImage, def:permRep}\leanok
...
\begin{lemma}[Semisimplicity of Permutation Module]\label{lem:permModule_isSemisimple}
  \lean{SchurWeyl.permModule_isSemisimple}\uses{def:permRep, def:PermModule}\leanok
...
\begin{lemma}[Finiteness of Permutation Module over Endomorphism Ring]\label{lem:permModule_finite_over_endRing}
  \lean{SchurWeyl.permModule_finite_over_endRing}\uses{def:PermModule}\leanok
...
\begin{theorem}[Jacobson Density for Permutation Representation]\label{thm:permModule_toModuleEnd_surjective}
  \lean{SchurWeyl.permModule_toModuleEnd_surjective}\uses{lem:permModule_isSemisimple, lem:permModule_finite_over_endRing, def:permRep}\leanok
