...
\begin{definition}[Endomorphism Matrix Representation]\label{def:toEndMatrix}
  \lean{SchurWeyl.toEndMatrix'}\uses{def:tensorBasis, def:diagAction}\leanok
...
\begin{lemma}[Matrix Representation of Diagonal Action]\label{lem:toEndMatrix'_diagAction}
...
\begin{lemma}[Matrix Orbit Invariance]\label{lem:matrix_orbit_invariant}
  \lean{SchurWeyl.matrix_orbit_invariant}\uses{def:permImage, def:toEndMatrix, lem:permAction_tensorBasis', def:permAction, def:toEndMatrix, lem:permAction_tensorBasis', def:tensorBasis}\leanok
...
\begin{theorem}[Hard Direction of Schur-Weyl Duality]\label{thm:centralizer_diagImage_le_span_permImage}
  \lean{SchurWeyl.centralizer_diagImage_le_span_permImage}\uses{thm:centralizer_diagImage_le_span_permImage_small}\leanok
  The centralizer of the diagonal image is contained in the span of the permutation image:
  \begin{equation}
