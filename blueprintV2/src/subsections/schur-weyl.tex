...
\begin{theorem}[Double Commutant containment for Permutation Algebra]\label{thm:double_centralizer_permImage'}
  \lean{SchurWeyl.double_centralizer_permImage'}\uses{thm:permModule_toModuleEnd_surjective, def:permImage, def:doubleCentralizer_to_endEndModule, lem:mem_span_permImage_of_mem_range}\leanok
